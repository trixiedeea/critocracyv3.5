...
export const ageOfExpansionPath = {
    ...
    segments: [
      ...
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[154, 428]], Next: [[166, 398]], Type: "draw", spaceId: "2P" },
      ...
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[194, 337]], Next: [[213, 309]], Type: "draw", spaceId: "5P" },
...
export const ageOfResistancePath = {
    ...
    segments: [
      ...
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[222, 450]], Next: [[245, 424]], Type: "draw" , spaceId: "2B" },
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[245, 424]], Next: [[271, 399]], Type: "draw" , spaceId: "3B" },
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[271, 399]], Next: [[301, 370]], Type: "draw" , spaceId: "4B" },
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[301, 370]], Next: [[334, 340]], Type: "draw" , spaceId: "5B" },
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[334, 340]], Next: [[380, 317]], Type: "draw" , spaceId: "6B" },
      ...
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[911, 829]], Next: [[928, 799]], Type: "regular" , spaceId: "32B" },	
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[928, 799]], Next: [[962, 766]], Type: "draw" , spaceId: "33B" },	
...
export const ageOfReckoningPath = {
    ...
    segments: [
      ...
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[182, 533]], Next: [[209, 539]], Type: "draw", spaceId: "0C" },
      ...
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[242, 598]], Next: [[263, 618]], Type: "draw", spaceId: "3C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[263, 618]], Next: [[290, 639]], Type: "draw", spaceId: "4C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[290, 639]], Next: [[320, 658]], Type: "draw", spaceId: "5C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[320, 658]], Next: [[350, 651]], Type: "draw", spaceId: "6C" },
      ...
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[530, 478]], Next: [[528, 442]], Type: "draw", spaceId: "18C" },
...
export const ageOfLegacyPath = {
    ...
    segments: [
      ...
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[157, 545]], Next: [[155, 583]], Type: "draw", spaceId: "0PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[155, 583]], Next: [[162, 611]], Type: "draw", spaceId: "1PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[162, 611]], Next: [[173, 641]], Type: "draw", spaceId: "2PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[173, 641]], Next: [[186, 673]], Type: "draw", spaceId: "3PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[186, 673]], Next: [[218, 698]], Type: "draw", spaceId: "4PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[218, 698]], Next: [[240, 729]], Type: "draw", spaceId: "5PK" },
      ...
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[318, 777]], Next: [[348, 785]], Type: "draw", spaceId: "9PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[348, 785]], Next: [[378, 790]], Type: "draw", spaceId: "10PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[378, 790]], Next: [[419, 790]], Type: "draw", spaceId: "11PK" },
      ...
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[504, 787]], Next: [[528, 781]], Type: "draw", spaceId: "14PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[528, 781]], Next: [[562, 770]], Type: "draw", spaceId: "15PK" },
