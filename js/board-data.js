...
export const ageOfExpansionPath = {
    ...
    segments: [
      ...
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[166, 398]], Next: [[180, 366]], Type: "regular", spaceId: "3P" },
      ...
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[213, 309]], Next: [[244, 286]], Type: "draw", spaceId: "6P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[244, 286]], Next: [[272, 269]], Type: "regular", spaceId: "7P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[272, 269]], Next: [[308, 257]], Type: "draw", spaceId: "8P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[308, 257]], Next: [[343, 252]], Type: "regular", spaceId: "9P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[343, 252]], Next: [[378, 250]], Type: "regular", spaceId: "10P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[378, 250]], Next: [[413, 250]], Type: "draw", spaceId: "11P" },
      ...
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[511, 281]], Next: [[534, 302]], Type: "regular", spaceId: "15P" },
      ...
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[1019, 768]], Next: [[1047, 770]], Type: "draw" , spaceId: "37P" },
...
export const ageOfResistancePath = {
    ...
    segments: [
      ...
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[380, 317]], Next: [[419, 338]], Type: "draw" , spaceId: "7B" },
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[419, 338]], Next: [[442, 368]], Type: "regular" , spaceId: "8B" },
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[442, 368]], Next: [[457, 402]], Type: "draw" , spaceId: "9B" },
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[457, 402]], Next: [[475, 443]], Type: "regular" , spaceId: "10B" },
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[475, 443]], Next: [[488, 487]], Type: "draw" , spaceId: "11B" },
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[488, 487]], Next: [[502, 532], [511, 457]], Type: "choicepoint", pathNames: ["ageOfResistancePath, ageOfReckoningPath"] , spaceId: "12B" },
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[502, 532]], Next: [[514, 566]], Type: "draw" , spaceId: "13B" },
      ...
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[1173, 349]], Next: [[1201, 375]], Type:"regular", spaceId: "50B"},
...
export const ageOfReckoningPath = {
    ...
    segments: [
      ...
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[104, 512]], Next: [[182, 533]], Type: "start", spaceId: "start" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[182, 533]], Next: [[209, 539]], Type: "regular", spaceId: "0C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[209, 539]], Next: [[225, 572]], Type: "draw", spaceId: "1C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[225, 572]], Next: [[242, 598]], Type: "regular", spaceId: "2C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[242, 598]], Next: [[263, 618]], Type: "regular", spaceId: "3C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[263, 618]], Next: [[290, 639]], Type: "draw", spaceId: "4C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[290, 639]], Next: [[320, 658]], Type: "regular", spaceId: "5C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[320, 658]], Next: [[350, 651]], Type: "regular", spaceId: "6C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[350, 651]], Next: [[379, 649]], Type: "draw", spaceId: "7C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[379, 649]], Next: [[405, 645]], Type: "regular", spaceId: "8C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[405, 645]], Next: [[423, 636]], Type: "regular", spaceId: "9C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[423, 636]], Next: [[434, 632]], Type: "draw", spaceId: "10C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[434, 632]], Next: [[426, 611]], Type: "regular", spaceId: "11C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[426, 611]], Next: [[421, 584]], Type: "regular", spaceId: "12C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[421, 584]], Next: [[408, 558]], Type: "regular", spaceId: "13C" },
      ...
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[489, 483]], Next: [[511, 457], [502, 532]], Type: "choicepoint", pathNames: ["ageOfReckoningPath, ageOfResistancePath"] , spaceId: "17C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[511, 457]], Next: [[507, 440]], Type: "draw", spaceId: "18C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[507, 440]], Next: [[501, 414]], Type: "regular", spaceId: "19C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[501, 414]], Next: [[497, 380]], Type: "regular", spaceId: "20C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[497, 380]], Next: [[499, 344]], Type: "draw", spaceId: "21C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[499, 344]], Next: [[537, 302]], Type: "regular", spaceId: "22C" },
      ...
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[571, 227]], Next: [[601, 207]], Type: "draw", spaceId: "25C" },
      ...
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[669, 175]], Next: [[706, 175]], Type: "draw", spaceId: "28C" },
      ...
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1031, 574]], Next: [[1040, 571]], Type: "draw", spaceId: "45C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1055, 591]], Next: [[1076, 613]], Type: "regular", spaceId: "46C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1076, 613]], Next: [[1098, 628]], Type: "regular", spaceId: "47C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1098, 628]], Next: [[1128, 633]], Type: "draw", spaceId: "48C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1128, 633]], Next: [[1154, 635]], Type: "regular", spaceId: "49C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1154, 635]], Next: [[1180, 633]], Type: "draw", spaceId: "50C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1180, 633]], Next: [[1213, 619]], Type: "regular", spaceId: "51C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1213, 619]], Next: [[1238, 603]], Type: "draw", spaceId: "52C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1238, 603]], Next: [[1263, 576]], Type: "regular", spaceId: "53C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1263, 576]], Next: [[1290, 556]], Type: "regular", spaceId: "54C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1290, 556]], Next: [[1310, 540]], Type: "draw", spaceId: "55C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1310, 540]], Next: [[1328, 525]], Type: "regular", spaceId: "56C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1328, 525]], Next: [[1384, 512]], Type: "draw", spaceId: "57c" },
...
export const ageOfLegacyPath = {
    ...
    segments: [
      ...
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[157, 545]], Next: [[155, 583]], Type: "regular", spaceId: "0PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[155, 583]], Next: [[162, 611]], Type: "draw", spaceId: "1PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[162, 611]], Next: [[173, 641]], Type: "regular", spaceId: "2PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[173, 641]], Next: [[186, 673]], Type: "regular", spaceId: "3PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[186, 673]], Next: [[218, 698]], Type: "draw", spaceId: "4PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[218, 698]], Next: [[240, 729]], Type: "regular", spaceId: "5PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[240, 729]], Next: [[263, 748]], Type: "draw", spaceId: "6PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[263, 748]], Next: [[286, 765]], Type: "regular", spaceId: "7PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[286, 765]], Next: [[318, 777]], Type: "draw", spaceId: "8PK" },
      ...
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[419, 790]], Next: [[455, 791]], Type: "draw", spaceId: "12PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[455, 791]], Next: [[504, 782]], Type: "regular", spaceId: "13PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[504, 782]], Next: [[523, 771]], Type: "regular", spaceId: "14PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[523, 771]], Next: [[559, 760]], Type: "draw", spaceId: "15PK" },
      { pathColor: "pink", pathName: "ageOfLegacyPath", coordinates: [[559, 760]], Next: [[585, 739], [572, 810]], Type: "choicepoint", pathNames: ["ageOfLegacyPath, ageOfResistancePath"] , spaceId: "16PK" },
