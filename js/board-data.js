...
export const ageOfExpansionPath = {
    ...
    segments: [
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[104, 512]], Next: [[144, 456]], spaceId: "START" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[144, 456]], Next: [[154, 426]], Type: "Regular" , spaceId: "1P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[154, 426]], Next: [[165, 400]], Type: "Regular" , spaceId: "2P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[165, 400]], Next: [[178, 367]], Type: "Regular" , spaceId: "3P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[178, 367]], Next: [[195, 333]], Type: "Draw" , spaceId: "4P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[195, 333]], Next: [[217, 305]], Type: "Regular" , spaceId: "5P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[217, 305]], Next: [[243, 281]], Type: "Regular" , spaceId: "6P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[243, 281]], Next: [[276, 270]], Type: "Regular" , spaceId: "7P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[276, 270]], Next: [[308, 256]], Type: "Regular" , spaceId: "8P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[308, 256]], Next: [[346, 252]], Type: "Regular" , spaceId: "9P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[346, 252]], Next: [[377, 247]], Type: "Draw" , spaceId: "10P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[377, 247]], Next: [[414, 250]], Type: "Regular" , spaceId: "11P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[414, 250]], Next: [[446, 250]], Type: "Regular" , spaceId: "12P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[446, 250]], Next: [[479, 263]], Type: "Regular" , spaceId: "13P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[479, 263]], Next: [[505, 274]], Type: "Draw" , spaceId: "14P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[505, 274]], Next: [[537, 302]], Type: "Regular" , spaceId: "15P" },
      { pathColor: "purple", pathName: "ageOfExpansionPath", coordinates: [[537, 302]], Next: [[567, 328], [544, 259]], Type: "Choicepoint", pathNames: ["ageOfExpansionPath, ageOfReckoningPath"] , spaceId: "16P" },
...
export const ageOfResistancePath = {
    ...
    segments: [
      ...
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[195, 475]], Next: [[222, 450]], Type: "Regular" , spaceId: "1B" },
      ...
      { pathColor: "blue", pathName: "ageOfResistancePath", coordinates: [[301, 370]], Next: [[334, 340]], Type: "Regular" , spaceId: "5B" },
...
export const ageOfReckoningPath = {
    ...
    segments: [
      ...
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1124, 654]], Next: [[1159, 654]], Type: "Regular",	spaceId: "49C" },
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1159, 654]], Next: [[1156, 664]], Type: "Regular",	spaceId: "50C" },
      ...
      { pathColor: "cyan", pathName: "ageOfReckoningPath", coordinates: [[1384, 512]], Type: "FINISH_SPACE" ,	spaceId: "FINISH" },
// NOTE: Last space should implicitly lead to FINISH based on coordinates
]
};
