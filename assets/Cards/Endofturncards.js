...
export const endOfTurnDeck = [
    ...
    },
    {
        ...
        effects: {
            ...
            POLITICIAN:    { type: 'RESOURCE_CHANGE', changes: { money: -2, knowledge: -2, influence: -2 }, explanation: "The public demands action on reparations." },
            ARTIST:        { type: 'RESOURCE_CHANGE', changes: { money: 2, knowledge: 2, influence: 5 }, explanation: "Your work highlights the need for reparations." }
        }
    },
    {
        deck: "End of Turn",
